    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-gray max-w-none">
          <p className="text-gray-600 mb-6">2025.07.02</p>
          
          <p className="mb-6">
            メディファンドを運営するi-SHOT株式会社（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）におけるプライバシー情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
          </p>

          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">第1条（プライバシー情報）</h2>
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">第２条（プライバシー情報の収集方法）</h2>
          <ol className="list-decimal list-inside space-y-4 mb-6">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">第３条（個人情報を収集・利用する目的）</h2>
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">第４条（個人情報の第三者提供）</h2>
          <ol className="list-decimal list-inside space-y-4 mb-6">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">第５条（個人情報の開示）</h2>
          <ol className="list-decimal list-inside space-y-4 mb-6">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">第６条（個人情報の訂正および削除）</h2>
          <ol className="list-decimal list-inside space-y-4 mb-6">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">第７条（個人情報の利用停止等）</h2>
          <p className="mb-6">
            当社は，本人から，個人情報が，利用目的の範囲を超えて取り扱われているという理由，または不正の手段により取得されたものであるという理由により，その利用の停止または消去（以下，「利用停止等」といいます。）を求められた場合には，遅滞なく必要な調査を行い，その結果に基づき，個人情報の利用停止等を行い，その旨本人に通知します。ただし，個人情報の利用停止等に多額の費用を有する場合その他利用停止等を行うことが困難な場合であって，本人の権利利益を保護するために必要なこれに代わるべき措置をとれる場合は，この代替策を講じます。
          </p>

          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">第８条（プライバシーポリシーの変更）</h2>
          <ol className="list-decimal list-inside space-y-4 mb-6">
            <li>本ポリシーの内容は，ユーザーに通知することなく，変更することができるものとします。</li>
            <li>当社が別途定める場合を除いて，変更後のプライバシーポリシーは，本ウェブサイトに掲載したときから効力を生じるものとします。</li>
          </ol>

          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">第９条（お問い合わせ窓口）</h2>
          <p className="mb-4">本ポリシーに関するお問い合わせは，下記の窓口までお願いいたします。</p>
          <div className="bg-gray-50 p-6 rounded-lg">
            <p className="font-semibold mb-2">i-SHOT株式会社</p>
            <p>代表取締役：原田 悠暉</p>
            <p>〒150-6139</p>
            <p>東京都渋谷区渋谷2-24-12 渋谷スクランブルスクエア39F</p>
            <p>tel : 052-990-1007</p>
            <p>mail : contact@medifund.jp</p>
          </div>
        </div>
      </div>
    </div>
